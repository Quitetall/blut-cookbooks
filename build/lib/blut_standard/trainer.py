...
def run(spec: dict[str, Any]) -> int:
    ...
    try:
        ...
        emit_failed(
            ...
            f"Install the supported runtime with: "
            f"pip install 'blut-cookbook-standard[training]==0.2.0a1'"
        )
        return 1
    ...
    from blut_standard.datasets_loader import load_jsonl_dataset  # noqa: E402
