"""ai_models/student/soap_optimizer.py — SOAP optimizer (vendored from nikhilvyas/SOAP).
...
from blut_core.ingredients.optimizer.cautious_wd import cautious_decoupled_wd_
